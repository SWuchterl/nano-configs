...
if [[ $1 == 2024* ]]; then
    python3 crab.py \
        -p data_2024_NANO.py \
        --site T2_CH_CSCS \
        -o /store/group/cmst3/group/hplushf/NanoTuples/2024/data \
    ...
    python3 crab.py \
        -p mc_2024_NANO.py \
        --site T2_CH_CSCS \
        -o /store/group/cmst3/group/hplushf/NanoTuples/2024/mc \
        -t NanoTuples-uParTv3-parTlepID-NanoAODv15 \
        -i  mc/mc_2024.conf \
        -e exe_ULv15_nosel.sh \
        --num-cores 2 \
...
if [[ $1 == 2025* ]]; then
    python3 crab.py \
        -p data_2025_NANO.py \
        --site T2_CH_CSCS \
        -o /store/group/cmst3/group/hplushf/NanoTuples/2025/data \
        -t NanoTuples-uParTv3-parTlepID-NanoAODv15 \
...
if [[ $1 == 2022* ]]; then
    python3 crab.py \
        -p data_2022_NANO.py \
        --site T2_CH_CSCS \
        -o /store/group/cmst3/group/hplushf/NanoTuples/2022/data \
        -t NanoTuples-uParTv3-parTlepID-NanoAODv15 \
...
if [[ $1 == 2023* ]]; then
    python3 crab.py \
        -p data_2023_NANO.py \
        --site T2_CH_CSCS \
        -o /store/group/cmst3/group/hplushf/NanoTuples/2023/data \
        -t NanoTuples-uParTv3-parTlepID-NanoAODv15 \
